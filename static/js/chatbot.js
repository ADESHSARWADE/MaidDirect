...
function sendMessageToChatbot(message) {
    ...
    let response = handleUserMessage(message);
...
function handleUserMessage(message) {
    ...
    else if (message.toLowerCase().includes("aboutus")) {
        response = '<a href="/about_us">Click here to know about us</a>';
    }
    ...
    // Links to Pages and Navigation
        ...
        response = '<a href="/">Click here to go back to Home</a>';
