...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    FOREIGN KEY (maid_id) REFERENCES maids(id)
        ...
        cursor.execute('''
CREATE TABLE IF NOT EXISTS messages_cust (
    id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP
        ...
        cursor.execute('''
CREATE TABLE IF NOT EXISTS messages_maid (
    id INT AUTO_INCREMENT PRIMARY KEY,
    sender_role ENUM('admin', 'maid') NOT NULL,
    sender_id INT NOT NULL,
    receiver_id INT NOT NULL,
    message TEXT NOT NULL,
    timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE IF NOT EXISTS messages_admin (
    id INT AUTO_INCREMENT PRIMARY KEY,
    sender_role ENUM('customer', 'maid') NOT NULL,
    sender_id INT NOT NULL,
    receiver_id INT NOT NULL,
    message TEXT NOT NULL,
    timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP
...
def register_maid():
    if request.method == 'POST':
        ...
        # Flash success message
        flash('Thank you for registering! Your profile has been created. After verification in 2 working days You will be able to recieve bookings', 'success')
